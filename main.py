...
def main():
    ...
    for idx in range(args.num_tasks or 0):
        ...
        for epoch in range(1, train_epochs + 1):
            ...
            curr_acc[idx] = test(
                model, writer, criterion, data_loader.test_loader, data_loader.test_transform, epoch, idx
            )

            if curr_acc[idx] > best_acc[idx]:
                best_acc[idx] = curr_acc[idx]
        ...
        utils.write_result_to_csv(
            ...
            curr_acc=curr_acc[idx],
            best_acc=best_acc[idx],
            save_dir=run_base_dir,
        )
        ...
        # args.eval_ckpts = range(1, args.num_tasks+1)
